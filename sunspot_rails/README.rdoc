...
Solr home in your project directory. In order to do so, create directories
<code>RAILS_ROOT/solr/conf</code> and <code>RAILS_ROOT/solr/lib</code>,
and copy in the contents of the Solr gem's
<code>solr/solr/conf</code>, <code>solr/solr/lib</code> directories.
If the files are in the right place,
